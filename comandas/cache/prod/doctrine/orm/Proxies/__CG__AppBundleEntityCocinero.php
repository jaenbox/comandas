 ...
 */
class Cocinero extends \AppBundle\Entity\Cocinero implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'pedidos', 'id', 'username', 'surname', 'dni', 'phone', 'email', 'address', 'password', 'isActive', 'salt', 'roles'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cocinero $proxy) {
    ...
    public function addPedido(\AppBundle\Entity\Pedido $pedidos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPedido', [$pedidos]);
    ...
    public function removePedido(\AppBundle\Entity\Pedido $pedidos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePedido', [$pedidos]);
