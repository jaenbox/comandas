...
class __TwigTemplate_707edc870ce55cabc1c006119ee238f1f365bbb2ead2ae5b1811bfd84fdae39e extends Twig_Template
{
    ...
    <span class=\"label ";
        // line 56
        echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "messageCount", array())) ? ("") : ("disabled"));
        echo "\">
        ";
        // line 57
        if (((isset($context["profiler_markup_version"]) ? $context["profiler_markup_version"] : null) == 1)) {
        ...
        ";
        // line 64
        if (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "messageCount", array()) > 0)) {
            // line 65
...
";
    ...
    ";
        // line 89
        if ( !$this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "mailers", array())) {
            // line 90
    ...
    ";
        // line 95
        if ((((isset($context["profiler_markup_version"]) ? $context["profiler_markup_version"] : null) == 1) || (twig_length_filter($this->env, $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "mailers", array())) > 1))) {
            // line 96
            echo "        <table>
            <thead>
                <tr>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                echo "</td>
                        <td class=\"font-normal\">";
                // line 111
                echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "isDefaultMailer", array(0 => $context["name"]), "method")) ? ("This is the default mailer") : (""));
                echo "</td>
                    </tr>
                ";
            }
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "isSpool", array(0 => $context["name"]), "method")) ? ("spooled") : ("sent"));
                echo " ";
                echo ((($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "messageCount", array(0 => $context["name"]), "method") == 1)) ? ("message") : ("messages"));
                echo "</span>
                </div>
            ";
            }
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
            // line 128
            echo "        ";
            if ((twig_length_filter($this->env, $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "mailers", array())) > 1)) {
                // line 129
                echo "            <h3>
                ";
                // line 130
                ...
                <small>";
                // line 131
                echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "isDefaultMailer", array(0 => $context["name"]), "method")) ? ("(default app mailer)") : (""));
                echo "</small>
            </h3>
        ";
            }
    ...
    {
        return new Twig_Source("", "SwiftmailerBundle:Collector:swiftmailer.html.twig", "/home/linuxjaen/Escritorio/proyecto_dam/comandas/vendor/symfony/swiftmailer-bundle/Resources/views/Collector/swiftmailer.html.twig");
    }
}
