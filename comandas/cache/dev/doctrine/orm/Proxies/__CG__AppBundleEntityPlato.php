 ...
 */
class Plato extends \AppBundle\Entity\Plato implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'price', 'path', 'description', 'file', 'category', 'comandas', '' . "\0" . 'AppBundle\\Entity\\Plato' . "\0" . 'temp'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Plato $proxy) {
    ...
    public function setPath($file)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPath', [$file]);

        return parent::setPath($file);
    }
    ...
    public function addComanda(\AppBundle\Entity\Comanda $comanda)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addComanda', [$comanda]);

        return parent::addComanda($comanda);
    }
    ...
    public function removeComanda(\AppBundle\Entity\Comanda $comanda)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeComanda', [$comanda]);

        return parent::removeComanda($comanda);
    }
