...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'comandas', 'user' => 'root', 'password' => 'Lara2015', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7e9f3a1ca83c4d2504355e5c3612622d0a8f05acc5b351a8662c9cb8bd1fbe5c');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/logout');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/index');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/new');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/edit');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/delete');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/show');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/list');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/camarero/new');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/camarero/edit');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/camarero/delete');

        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('^/camarero/show');

        $t = new \Symfony\Component\HttpFoundation\RequestMatcher('^/camarero/list');

        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('^/cocinero/new');

        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('^/cocinero/edit');

        $w = new \Symfony\Component\HttpFoundation\RequestMatcher('^/cocinero/list');

        $x = new \Symfony\Component\HttpFoundation\RequestMatcher('^/mesa/new');

        $y = new \Symfony\Component\HttpFoundation\RequestMatcher('^/mesa/edit');

        $z = new \Symfony\Component\HttpFoundation\RequestMatcher('^/mesa/delete');

        $aa = new \Symfony\Component\HttpFoundation\RequestMatcher('^/mesa/show');

        $ba = new \Symfony\Component\HttpFoundation\RequestMatcher('^/mesa/list');

        $ca = new \Symfony\Component\HttpFoundation\RequestMatcher('^/plato/edit');

        $da = new \Symfony\Component\HttpFoundation\RequestMatcher('^/plato/delete');

        $ea = new \Symfony\Component\HttpFoundation\RequestMatcher('^/plato/show');

        $fa = new \Symfony\Component\HttpFoundation\RequestMatcher('^/plato/list');

        $ga = new \Symfony\Component\HttpFoundation\RequestMatcher('^/comanda/list');

        $ha = new \Symfony\Component\HttpFoundation\RequestMatcher('^/comanda/edit');

        $ia = new \Symfony\Component\HttpFoundation\RequestMatcher('^/option');

        $ja = new \Symfony\Component\Security\Http\AccessMap();
        $ja->add($g, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $ja->add($h, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $ja->add($i, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $ja->add($j, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $ja->add($k, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($l, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($m, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($n, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($o, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($p, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($q, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($r, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($s, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($t, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($u, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($v, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($w, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($x, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($y, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($z, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($aa, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($ba, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($ca, array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_COCINERO'), NULL);
        $ja->add($da, array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_COCINERO'), NULL);
        $ja->add($ea, array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_COCINERO'), NULL);
        $ja->add($fa, array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_COCINERO'), NULL);
        $ja->add($ga, array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_COCINERO', 2 => 'ROLE_CAMARERO'), NULL);
        $ja->add($ha, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $ja->add($ia, array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_COCINERO', 2 => 'ROLE_CAMARERO'), NULL);

        $ka = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $la = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $ka, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($ka, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $la->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $ma = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($ka, array());
        $ma->setOptions(array('login_path' => '/', 'default_target_path' => 'index', 'always_use_default_target_path' => true, 'use_referer' => true, 'target_path_parameter' => '_target_path'));
        $ma->setProviderKey('main');

        $na = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $ka, array(), $a);
        $na->setOptions(array('login_path' => '/', 'failure_path' => '/', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $oa = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $ka, '/', false);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($ja, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.db_provider')), 'main', $a, $c), 2 => $la, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $ka, 'main', $ma, $na, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $f, 'main', $oa, $a), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '59adc050354d76.16334529', $a, $f), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $ja, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $ka, 'main', $oa, NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9d57f62bde1f44b3b35710e08365ac58af94d99b');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.db_provider'), new \Symfony\Component\Security\Core\User\UserChecker(), 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59adc050354d76.16334529')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_CAMARERO' => array(0 => 'ROLE_CAMARERO'), 'ROLE_COCINERO' => array(0 => 'ROLE_COCINERO'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_CAMARERO', 1 => 'ROLE_COCINERO')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:User', NULL, NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'comandas',
            'database_user' => 'root',
            'database_password' => 'Lara2015',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '9d57f62bde1f44b3b35710e08365ac58af94d99b',
            'locale' => 'en',
            ...
            'kernel.secret' => '9d57f62bde1f44b3b35710e08365ac58af94d99b',
            ...
            'assetic.node.bin' => '/usr/local/heroku/bin/node',
